...
const RacingBarChart = () => {
    ...
    }, [renderSVG, isDarkMode, status, data]);
    ...
    return (
        <div className='bar-chart__wrapper'>
            ...
            {(status === 'pending') && <LoadingComp loadingText={'Loading data'}/>}
            {(status === 'rejected') && <ErrorComp errorText={'Error loading data'} />}
